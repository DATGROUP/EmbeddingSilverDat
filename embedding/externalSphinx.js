...
var SphinxClass = ( function() {
        ...
        function Sphinx() {
            ...
            // fiOnline default.
            this.productVariant = 'fiOnline';
            this.error = null;

            var msgListener = function( msg ) {
                if ( msg != null && msg.data != null ) {
                    console.log( "received message " + JSON.stringify(msg.data) + " of type " + msg.type );

                    // the "message" member is used for redirect URLs (probably some historic thing...)
                    if ( msg.data.type == null && msg.data.message != null ) {
